...
Menu screenFiltersMenu = {
    "スクリーンフィルター",
    {
        { "[6500K]  (デフォルト)", METHOD, .method = &ScreenFiltersMenu_SetDefault },
        { "[10000K]", METHOD, .method = &ScreenFiltersMenu_SetAquarium },
        { "[7500K]", METHOD, .method = &ScreenFiltersMenu_SetOvercastSky },
        { "[5500K]", METHOD, .method = &ScreenFiltersMenu_SetDaylight },
        { "[4200K]", METHOD, .method = &ScreenFiltersMenu_SetFluorescent },
        { "[3400K]", METHOD, .method = &ScreenFiltersMenu_SetHalogen },
        { "[2700K]", METHOD, .method = &ScreenFiltersMenu_SetIncandescent },
        { "[2300K]", METHOD, .method = &ScreenFiltersMenu_SetWarmIncandescent },
        { "[1900K]", METHOD, .method = &ScreenFiltersMenu_SetCandle },
        { "[1200K]", METHOD, .method = &ScreenFiltersMenu_SetEmber },
        {},
    }
};
